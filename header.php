...
if (empty($nama)){ #jika user belum login maka di alihkan ke halaman index.php
...
<html>
<head>
<title>Upload File Gratis</title>
...
<div id="header">
	<div class="inHeader">
		<div class="mosAdmin">
		<a href="account">
		<img src="<?PHP echo $photo; ?>" height="50" width="50"/>
		</a>
		Welcome, <?PHP echo $nama; ?><br>
