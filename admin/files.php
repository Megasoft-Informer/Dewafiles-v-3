...
<div id="wrapper">
	...
	<table class="data">
			...
			<tr class="data">
				...
				<center>
				<a target="_blank" href="../<?PHP echo "downloads.php?id=$id"; ?>" title="view details"><img src="../css/img/detail.png"></a>
				<a href="delete_files.php?id=<?PHP echo $id; ?>" title="Delete File"><img src="../css/img/delete.png"></a>&nbsp;&nbsp;&nbsp;
				</center>
				</td>
			</tr>
			<?PHP
